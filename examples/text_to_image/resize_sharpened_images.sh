...
nohup python metrics_files.py --source_path "./outputs/seed_42/finetuned_lora+text_weighting_2_1/checkpoint-3000/" --save_path "outputs/seed_42/resized/finetuned_lora+text_weighting_2_1/checkpoint-3000/" > fltw21_371.out &
