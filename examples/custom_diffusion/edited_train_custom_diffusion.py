...
def main(args):
    ...
    if args.modifier_token is not None:
        ...
        # )
        custom_diffusion_layers, text_encoder, optimizer = accelerator.prepare(
            custom_diffusion_layers, text_encoder, optimizer
        )
    else:
    ...
    if args.resume_from_checkpoint:
        ...
        if path is None:
            ...
            image.save("./outputs/obama_outputs/obama_checkpoint" + str(1) + ".png")
            accelerator.print("Saved************************************************************")
            sys.exit(0)
